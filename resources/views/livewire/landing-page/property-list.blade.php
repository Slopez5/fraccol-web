<div class="container">
                    ...
                    <div class="rld-main-search">
                        <div class="row">
                            <div class="rld-single-input">
                                <input type="text" placeholder="Enter Keyword..." wire:model="search">
                            </div>
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-4 pl-0">
                                <button wire:click="searchProperty" class="btn btn-yellow" href="#">Search
                                    Now</button>
                            </div>
    ...
    <div class="row">
        @foreach ($properties as $index => $property)
            <x-landing-page.property-card wire:key='{{ $index }}' :property="$property" />
        @endforeach
    </div>
