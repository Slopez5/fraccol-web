    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-solid">
                <div class="card-body">
                    <div class="row">
                        @livewire('panel.real-estates.developments.show.section-images', ['development' => $development])

                        <div class="col-12 col-sm-6">
                            <h3 class="my-3">Fraccionamiento {{ $development->name }}</h3>
                            <p>{{ $development->sort_description }}</p>
                            <hr>
                            @livewire('panel.real-estates.developments.show.section-settings-lot-development', ['development' => $development])
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="tab-content p-3" id="nav-tabContent">
                            ...
                            <div class="tab-pane fade" id="product-rating" role="tabpanel"
                                ...
                                pellentesque
                                tortor vel nisl commodo ullamcorper. Donec varius massa at semper posuere. Integer finibus
                                orci
